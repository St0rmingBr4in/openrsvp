...
<div class="min-h-screen px-4 py-8 sm:py-12" style="background: linear-gradient(135deg, var(--color-neutral-50) 0%, var(--color-primary-lighter) 50%, var(--color-primary-light) 100%);">
