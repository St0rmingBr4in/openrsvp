		...
		<section class="relative overflow-hidden pt-16">
			...
			<div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 lg:py-40 text-center">
				...
				<h1 class="font-display text-5xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-neutral-900 mb-6 leading-[1.1]">
					{$_('landing.heroTitle1')}<br />
					<span class="bg-gradient-to-r from-primary via-pink-500 to-amber-500 bg-clip-text text-transparent">{$_('landing.heroTitle2')}</span>
				</h1>
			...
			<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					...
					<div class="group relative bg-surface rounded-xl p-8 shadow-sm border border-neutral-100 hover:shadow-md hover:border-primary-light transition-all">
						...
						<h3 class="text-lg font-semibold text-neutral-900 mb-2">{$_('landing.feat1Title')}</h3>
					...
					<div class="group relative bg-surface rounded-xl p-8 shadow-sm border border-neutral-100 hover:shadow-md hover:border-primary-light transition-all">
						...
						<h3 class="text-lg font-semibold text-neutral-900 mb-2">{$_('landing.feat2Title')}</h3>
						<p class="text-neutral-600 leading-relaxed">
							{$_('landing.feat2Body')}
						</p>
					</div>
					...
					<div class="group relative bg-surface rounded-xl p-8 shadow-sm border border-neutral-100 hover:shadow-md hover:border-primary-light transition-all">
						...
						<h3 class="text-lg font-semibold text-neutral-900 mb-2">{$_('landing.feat3Title')}</h3>
						<p class="text-neutral-600 leading-relaxed">
							{$_('landing.feat3Body')}
						</p>
					</div>
					...
					<div class="group relative bg-surface rounded-xl p-8 shadow-sm border border-neutral-100 hover:shadow-md hover:border-primary-light transition-all">
						...
						<h3 class="text-lg font-semibold text-neutral-900 mb-2">{$_('landing.feat4Title')}</h3>
						<p class="text-neutral-600 leading-relaxed">
							{$_('landing.feat4Body')}
						</p>
					</div>
					...
					<div class="group relative bg-surface rounded-xl p-8 shadow-sm border border-neutral-100 hover:shadow-md hover:border-primary-light transition-all">
						...
						<h3 class="text-lg font-semibold text-neutral-900 mb-2">{$_('landing.feat5Title')}</h3>
						<p class="text-neutral-600 leading-relaxed">
							{$_('landing.feat5Body')}
						</p>
					</div>
					...
					<div class="group relative bg-surface rounded-xl p-8 shadow-sm border border-neutral-100 hover:shadow-md hover:border-primary-light transition-all">
						...
						<h3 class="text-lg font-semibold text-neutral-900 mb-2">{$_('landing.feat6Title')}</h3>
						<p class="text-neutral-600 leading-relaxed">
							{$_('landing.feat6Body')}
						</p>
					</div>
